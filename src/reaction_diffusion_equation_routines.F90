...
#include "macros.h"  
  ...
  PUBLIC ReactionDiffusion_AnalyticBoundaryConditionsCalculate
...
CONTAINS
  ...
  SUBROUTINE ReactionDiffusion_AnalyticBoundaryConditionsCalculate(equationsSet,boundaryConditions,boundaryOnly,update,err,error,*)
    ...
    EXITS("ReactionDiffusion_AnalyticBoundaryConditionsCalculate")
    RETURN
999 ERRORS("ReactionDiffusion_AnalyticBoundaryConditionsCalculate",err,error)
    EXITS("ReactionDiffusion_AnalyticBoundaryConditionsCalculate")
    RETURN 1
    
  END SUBROUTINE ReactionDiffusion_AnalyticBoundaryConditionsCalculate
