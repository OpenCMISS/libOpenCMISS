...
#include "macros.h"  
  ...
  PUBLIC Poisson_AnalyticBoundaryConditionsCalculate
...
CONTAINS
  ...
  SUBROUTINE Poisson_AnalyticBoundaryConditionsCalculate(equationsSet,boundaryConditions,boundaryOnly,update,err,error,*)
    ...
    ENTERS("Poisson_AnalyticBoundaryConditionsCalculate",err,error,*999)
    ...
    EXITS("Poisson_AnalyticBoundaryConditionsCalculate")
    RETURN
999 ERRORSEXITS("Poisson_AnalyticBoundaryConditionsCalculate",err,error)
    RETURN 1
    
  END SUBROUTINE Poisson_AnalyticBoundaryConditionsCalculate
...
999 ERRORS("Poisson_EquationsSetSolutionMethodSet",err,error)
  ...
  SUBROUTINE Poisson_EquationsSetSpecificationSet(equationsSet,specification,err,error,*)
    ...
    CALL EquationsSet_SpecificationSet(equationsSet,3,[EQUATIONS_SET_CLASSICAL_FIELD_CLASS, &
      & EQUATIONS_SET_POISSON_EQUATION_TYPE,subtype],err,error,*999)
...
999 ERRORSEXITS("Poisson_PostSolveOutputData",err,error)
  ...
  SUBROUTINE Poisson_ProblemSpecificationSet(problem,problemSpecification,err,error,*)
    ...
    CALL Problem_SpecificationSet(problem,3,[PROBLEM_CLASSICAL_FIELD_CLASS,PROBLEM_POISSON_EQUATION_TYPE,problemSubtype], &
      & err,error,*999)
