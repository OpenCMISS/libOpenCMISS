...
!> \defgroup OpenCMISS_BioelectricFiniteElasticity OpenCMISS::BioelectricFiniteElasticity
...
999 ERRORS("BioelectricFiniteElasticity_FiniteElementCalculate",err,error)
  ...
  SUBROUTINE BioelectricFiniteElasticity_ProblemSpecificationSet(problem,problemSpecification,err,error,*)
    ...
    CALL Problem_SpecificationSet(problem,3,[PROBLEM_MULTI_PHYSICS_CLASS,PROBLEM_BIOELECTRIC_FINITE_ELASTICITY_TYPE, &
