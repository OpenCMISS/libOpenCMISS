  ...
  SUBROUTINE FSI_PostLoop(controlLoop,err,error,*)
    ...
    DO WHILE((equationsSetIndex<=numberOfEquationsSets.AND..NOT.solidEquationsSetFound) &
      ...
      IF(esSpecification(1)==EQUATIONS_SET_ELASTICITY_CLASS &
        ...
        & (esSpecification(3)==EQUATIONS_SET_CELLML_GROWTH_LAW_NEO_HOOKEAN_SUBTYPE).OR. &
        & (esSpecification(3)==EQUATIONS_SET_CELLML_GROWTH_LAW_MOONEY_RIVLIN_SUBTYPE).OR. &
        ...
        & (esSpecification(3)==EQUATIONS_SET_DYNAMIC_COMPRESSIBLE_ST_VENANT_KIRCHOFF_SUBTYPE).OR. &
        & (esSpecification(3)==EQUATIONS_SET_DYNAMIC_COMPRESSIBLE_MOONEY_RIVLIN_SUBTYPE))) THEN
