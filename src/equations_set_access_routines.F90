...
!  INTEGER(INTG), PARAMETER :: EQUATIONS_SET_INCOMPRESSIBLE_ELAST_MULTI_COMP_DARCY_SUBTYPE=14
  ...
  INTEGER(INTG), PARAMETER :: EQUATIONS_SET_SMALL_STRAIN_TENSOR=8 !<Small strain tensor \see EquationsSetRoutines_TensorTypes,EquationsSetRoutines
  INTEGER(INTG), PARAMETER :: EQUATIONS_SET_CAUCHY_STRESS_TENSOR=9 !<Cauchy stress tensor \see EquationsSetRoutines_TensorTypes,EquationsSetRoutines
  INTEGER(INTG), PARAMETER :: EQUATIONS_SET_CAUCHY_STRESS_TENSOR_FIBRE=10 !<Cauchy stress tensor wrt deformed fibres \see EquationsSetConstants_TensorTypes,EquationsSetConstants
  INTEGER(INTG), PARAMETER :: EQUATIONS_SET_FIRST_PK_STRESS_TENSOR=11 !<First Piola Kirchhoff stress tensor \see EquationsSetRoutines_TensorEvaluateTypes,EquationsSetRoutines
  INTEGER(INTG), PARAMETER :: EQUATIONS_SET_SECOND_PK_STRESS_TENSOR=12 !<Second Piola Kirchhoff stress tensor \see EquationsSetRoutines_TensorEvaluateTypes,EquationsSetRoutines
  INTEGER(INTG), PARAMETER :: EQUATIONS_SET_ELASTIC_WORK=13 !<Elastic work \see EquationsSetRoutines_TensorEvaluateTypes,EquationsSetRoutines
  !>@}
  INTEGER(INTG), PARAMETER :: EQUATIONS_SET_NUMBER_OF_TENSOR_TYPES=13
