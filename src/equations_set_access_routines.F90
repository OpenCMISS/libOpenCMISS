...
#include "macros.h"  
  ...
  INTEGER(INTG), PARAMETER :: EQUATIONS_SET_THREE_DIMENSIONAL_ISOTROPIC_SUBTYPE=4
  INTEGER(INTG), PARAMETER :: EQUATIONS_SET_THREE_DIMENSIONAL_ORTHOTROPIC_SUBTYPE=5
  INTEGER(INTG), PARAMETER :: EQUATIONS_SET_PLATE_SUBTYPE=6
  INTEGER(INTG), PARAMETER :: EQUATIONS_SET_SHELL_SUBTYPE=7
  INTEGER(INTG), PARAMETER :: EQUATIONS_SET_ONE_DIM_STOKES_DAMPING_SUBTYPE=8
  INTEGER(INTG), PARAMETER :: EQUATIONS_SET_TWO_DIM_PLANE_STRESS_STOKES_DAMPING_SUBTYPE=9
  !  Finite elasticity
  INTEGER(INTG), PARAMETER :: EQUATIONS_SET_ST_VENANT_KIRCHOFF_SUBTYPE=1
  INTEGER(INTG), PARAMETER :: EQUATIONS_SET_NEO_HOOKEAN_SUBTYPE=2
  INTEGER(INTG), PARAMETER :: EQUATIONS_SET_MOONEY_RIVLIN_SUBTYPE=3
  INTEGER(INTG), PARAMETER :: EQUATIONS_SET_ISOTROPIC_EXP_SUBTYPE=4
  INTEGER(INTG), PARAMETER :: EQUATIONS_SET_TRANS_ISOTROPIC_EXP_SUBTYPE=5
  INTEGER(INTG), PARAMETER :: EQUATIONS_SET_TRANS_ISOTROPIC_POLYNOMIAL_SUBTYPE=6
  INTEGER(INTG), PARAMETER :: EQUATIONS_SET_TRANS_ISOTROPIC_HUMPHREY_YIN_SUBTYPE=7
  INTEGER(INTG), PARAMETER :: EQUATIONS_SET_TRANS_ISOTROPIC_GUCCIONE_SUBTYPE=8
  INTEGER(INTG), PARAMETER :: EQUATIONS_SET_ORTHOTROPIC_COSTA_SUBTYPE=9
  INTEGER(INTG), PARAMETER :: EQUATIONS_SET_ORTHOTROPIC_HOLZAPFEL_OGDEN_SUBTYPE=10
  INTEGER(INTG), PARAMETER :: EQUATIONS_SET_ELASTICITY_DARCY_INRIA_MODEL_SUBTYPE=11
  INTEGER(INTG), PARAMETER :: EQUATIONS_SET_ELASTICITY_MULTI_COMPARTMENT_DARCY_INRIA_SUBTYPE=12
  INTEGER(INTG), PARAMETER :: EQUATIONS_SET_ANISOTROPIC_POLYNOMIAL_SUBTYPE=13
  INTEGER(INTG), PARAMETER :: EQUATIONS_SET_CONSTITUTIVE_LAW_IN_CELLML_EVALUATE_SUBTYPE=14
  
  INTEGER(INTG), PARAMETER :: EQUATIONS_SET_MEMBRANE_SUBTYPE=15
  
  INTEGER(INTG), PARAMETER :: EQUATIONS_SET_INCOMPRESSIBLE_FINITE_ELASTICITY_DARCY_SUBTYPE=16
  INTEGER(INTG), PARAMETER :: EQUATIONS_SET_INCOMPRESSIBLE_ELASTICITY_DRIVEN_DARCY_SUBTYPE=17
  INTEGER(INTG), PARAMETER :: EQUATIONS_SET_INCOMPRESSIBLE_ELASTICITY_DRIVEN_MR_SUBTYPE=18
  INTEGER(INTG), PARAMETER :: EQUATIONS_SET_INCOMPRESSIBLE_ELAST_MULTI_COMP_DARCY_SUBTYPE=19
  
  INTEGER(INTG), PARAMETER :: EQUATIONS_SET_ELASTICITY_FLUID_PRESSURE_STATIC_INRIA_SUBTYPE=20
  INTEGER(INTG), PARAMETER :: EQUATIONS_SET_ELASTICITY_FLUID_PRESSURE_HOLMES_MOW_SUBTYPE=21
  INTEGER(INTG), PARAMETER :: EQUATIONS_SET_ELASTICITY_FLUID_PRES_HOLMES_MOW_ACTIVE_SUBTYPE=22
  
  INTEGER(INTG), PARAMETER :: EQUATIONS_SET_COMPRESSIBLE_FINITE_ELASTICITY_SUBTYPE=23
  INTEGER(INTG), PARAMETER :: EQUATIONS_SET_COMPRESSIBLE_ST_VENANT_KIRCHOFF_SUBTYPE=24
  INTEGER(INTG), PARAMETER :: EQUATIONS_SET_COMPRESSIBLE_NEO_HOOKEAN_SUBTYPE=25
  INTEGER(INTG), PARAMETER :: EQUATIONS_SET_COMPRESSIBLE_MOONEY_RIVLIN_SUBTYPE=26
  
  INTEGER(INTG), PARAMETER :: EQUATIONS_SET_NEARLY_INCOMP_ST_VENANT_KIRCHOFF_SUBTYPE=27
  INTEGER(INTG), PARAMETER :: EQUATIONS_SET_NEARLY_INCOMP_NEO_HOOKEAN_SUBTYPE=28
  INTEGER(INTG), PARAMETER :: EQUATIONS_SET_NEARLY_INCOMP_MOONEY_RIVLIN_SUBTYPE=29
  
  INTEGER(INTG), PARAMETER :: EQUATIONS_SET_ACTIVE_CONTRACTION_SUBTYPE=30
  INTEGER(INTG), PARAMETER :: EQUATIONS_SET_ST_VENANT_KIRCHOFF_ACTIVE_CONTRACTION_SUBTYPE=31
  INTEGER(INTG), PARAMETER :: EQUATIONS_SET_NEO_HOOKEAN_ACTIVE_CONTRACTION_SUBTYPE=32
  INTEGER(INTG), PARAMETER :: EQUATIONS_SET_MOONEY_RIVLIN_ACTIVE_CONTRACTION_SUBTYPE=33
  INTEGER(INTG), PARAMETER :: EQUATIONS_SET_TRANS_ISOTROPIC_ACTIVE_CONTRACTION_SUBTYPE=34
  INTEGER(INTG), PARAMETER :: EQUATIONS_SET_ANISOTROPIC_POLYNOMIAL_ACTIVE_CONTRACTION_SUBTYPE=35
  INTEGER(INTG), PARAMETER :: EQUATIONS_SET_TRANS_ISOTROPIC_ACTIVE_TRANSITION_SUBTYPE=36
  INTEGER(INTG), PARAMETER :: EQUATIONS_SET_GUCCIONE_ACTIVE_CONTRACTION_SUBTYPE=37
  INTEGER(INTG), PARAMETER :: EQUATIONS_SET_GUCCIONE_ACTIVE_CONTRACTION_NOLENDEP_SUBTYPE=38
  INTEGER(INTG), PARAMETER :: EQUATIONS_SET_GUCCIONE_ACTIVE_CONTRACTION_2NDPIOLA_SUBTYPE=39
  INTEGER(INTG), PARAMETER :: EQUATIONS_SET_HOLZAPFEL_OGDEN_ACTIVE_CONTRACTION_SUBTYPE=40
  INTEGER(INTG), PARAMETER :: EQUATIONS_SET_COMPRESSIBLE_ACTIVE_CONTRACTION_SUBTYPE=41
  
  INTEGER(INTG), PARAMETER :: EQUATIONS_SET_CONSTITUTIVE_AND_GROWTH_LAW_IN_CELLML_SUBTYPE=42
  INTEGER(INTG), PARAMETER :: EQUATIONS_SET_CELLML_GROWTH_LAW_SUBTYPE=43
  INTEGER(INTG), PARAMETER :: EQUATIONS_SET_CELLML_GROWTH_LAW_ST_VENANT_SUBTYPE=44
  INTEGER(INTG), PARAMETER :: EQUATIONS_SET_CELLML_GROWTH_LAW_NEO_HOOKEAN_SUBTYPE=45
  INTEGER(INTG), PARAMETER :: EQUATIONS_SET_CELLML_GROWTH_LAW_MOONEY_RIVLIN_SUBTYPE=46
  INTEGER(INTG), PARAMETER :: EQUATIONS_SET_FIBRE_GROWTH_LAW_ST_VENANT_SUBTYPE=47
  INTEGER(INTG), PARAMETER :: EQUATIONS_SET_ISOTROPIC_GROWTH_LAW_ST_VENANT_SUBTYPE=48
  INTEGER(INTG), PARAMETER :: EQUATIONS_SET_TRANS_ISO_GROWTH_LAW_ST_VENANT_SUBTYPE=49
  INTEGER(INTG), PARAMETER :: EQUATIONS_SET_ORTHOTROPIC_GROWTH_LAW_ST_VENANT_SUBTYPE=50
  INTEGER(INTG), PARAMETER :: EQUATIONS_SET_FULL_TENSOR_GROWTH_LAW_ST_VENANT_SUBTYPE=51
  INTEGER(INTG), PARAMETER :: EQUATIONS_SET_FIBRE_GROWTH_LAW_NEO_HOOKEAN_SUBTYPE=52
  INTEGER(INTG), PARAMETER :: EQUATIONS_SET_ISOTROPIC_GROWTH_LAW_NEO_HOOKEAN_SUBTYPE=53
  INTEGER(INTG), PARAMETER :: EQUATIONS_SET_TRANS_ISO_GROWTH_LAW_NEO_HOOKEAN_SUBTYPE=54
  INTEGER(INTG), PARAMETER :: EQUATIONS_SET_ORTHOTROPIC_GROWTH_LAW_NEO_HOOKEAN_SUBTYPE=55
  INTEGER(INTG), PARAMETER :: EQUATIONS_SET_FULL_TENSOR_GROWTH_LAW_NEO_HOOKEAN_SUBTYPE=56
  INTEGER(INTG), PARAMETER :: EQUATIONS_SET_FIBRE_GROWTH_LAW_MOONEY_RIVLIN_SUBTYPE=57
  INTEGER(INTG), PARAMETER :: EQUATIONS_SET_ISOTROPIC_GROWTH_LAW_MOONEY_RIVLIN_SUBTYPE=58
  INTEGER(INTG), PARAMETER :: EQUATIONS_SET_TRANS_ISO_GROWTH_LAW_MOONEY_RIVLIN_SUBTYPE=59
  INTEGER(INTG), PARAMETER :: EQUATIONS_SET_ORTHOTROPIC_GROWTH_LAW_MOONEY_RIVLIN_SUBTYPE=60
  INTEGER(INTG), PARAMETER :: EQUATIONS_SET_FULL_TENSOR_GROWTH_LAW_MOONEY_RIVLIN_SUBTYPE=61
  
  INTEGER(INTG), PARAMETER :: EQUATIONS_SET_ACTIVE_STRAIN_SUBTYPE=62
  INTEGER(INTG), PARAMETER :: EQUATIONS_SET_MULTISCALE_ACTIVE_STRAIN_SUBTYPE=63
  
  INTEGER(INTG), PARAMETER :: EQUATIONS_SET_RATE_BASED_SMOOTH_MODEL_SUBTYPE=64
  INTEGER(INTG), PARAMETER :: EQUATIONS_SET_RATE_BASED_GROWTH_MODEL_SUBTYPE=65
  INTEGER(INTG), PARAMETER :: EQUATIONS_SET_COMPRESSIBLE_RATE_BASED_SMOOTH_MODEL_SUBTYPE=66
  INTEGER(INTG), PARAMETER :: EQUATIONS_SET_COMPRESSIBLE_RATE_BASED_GROWTH_MODEL_SUBTYPE=67
  
  INTEGER(INTG), PARAMETER :: EQUATIONS_SET_REFERENCE_STATE_ST_VENANT_KIRCHOFF_SUBTYPE=68
  INTEGER(INTG), PARAMETER :: EQUATIONS_SET_REFERENCE_STATE_NEO_HOOKEAN_SUBTYPE=69
  INTEGER(INTG), PARAMETER :: EQUATIONS_SET_REFERENCE_STATE_MOONEY_RIVLIN_SUBTYPE=70
  INTEGER(INTG), PARAMETER :: EQUATIONS_SET_REFERENCE_STATE_TRANS_GUCCIONE_SUBTYPE=71
  
  INTEGER(INTG), PARAMETER :: EQUATIONS_SET_DYNAMIC_ST_VENANT_KIRCHOFF_SUBTYPE=72
  INTEGER(INTG), PARAMETER :: EQUATIONS_SET_DYNAMIC_NEO_HOOKEAN_SUBTYPE=73
  INTEGER(INTG), PARAMETER :: EQUATIONS_SET_DYNAMIC_MOONEY_RIVLIN_SUBTYPE=74
  
  INTEGER(INTG), PARAMETER :: EQUATIONS_SET_DYNAMIC_COMPRESSIBLE_ST_VENANT_KIRCHOFF_SUBTYPE=75
  INTEGER(INTG), PARAMETER :: EQUATIONS_SET_DYNAMIC_COMPRESSIBLE_NEO_HOOKEAN_SUBTYPE=76
  INTEGER(INTG), PARAMETER :: EQUATIONS_SET_DYNAMIC_COMPRESSIBLE_MOONEY_RIVLIN_SUBTYPE=77
  
  INTEGER(INTG), PARAMETER :: EQUATIONS_SET_DYNAMIC_NEARLY_INCOMP_ST_VENANT_KIRCHOFF_SUBTYPE=78
  INTEGER(INTG), PARAMETER :: EQUATIONS_SET_DYNAMIC_NEARLY_INCOMP_NEO_HOOKEAN_SUBTYPE=79
  INTEGER(INTG), PARAMETER :: EQUATIONS_SET_DYNAMIC_NEARLY_INCOMP_MOONEY_RIVLIN_SUBTYPE=80

  !Options locations
  INTEGER(INTG), PARAMETER :: EQUATIONS_SET_EQUATION_CLASS_OPTION=1
  INTEGER(INTG), PARAMETER :: EQUATIONS_SET_EQUATION_TYPE_OPTION=2
  INTEGER(INTG), PARAMETER :: EQUATIONS_SET_EQUATION_SUBTYPE_OPTION=3
  INTEGER(INTG), PARAMETER :: EQUATIONS_SET_TEMPORAL_ANALYSIS_OPTION=4
  INTEGER(INTG), PARAMETER :: EQUATIONS_SET_DAMPING_OPTION=5
  INTEGER(INTG), PARAMETER :: EQUATIONS_SET_CONSTITUTIVE_LAW_OPTION=6
  INTEGER(INTG), PARAMETER :: EQUATIONS_SET_MATERIAL_COMPRESSIBILITY_OPTION=7
  INTEGER(INTG), PARAMETER :: EQUATIONS_SET_SOLUTION_CONFIGURATION_OPTION=8
  INTEGER(INTG), PARAMETER :: EQUATIONS_SET_ACTIVE_CONTRACTION_OPTION=9
  INTEGER(INTG), PARAMETER :: EQUATIONS_SET_MATERIAL_GROWTH_OPTION=10
  INTEGER(INTG), PARAMETER :: EQUATIONS_SET_MATERIAL_GROWTH_LAW_OPTION=11
  INTEGER(INTG), PARAMETER :: EQUATIONS_SET_MATERIAL_ANISOTROPY_OPTION=12
  INTEGER(INTG), PARAMETER :: EQUATIONS_SET_MAX_OPTIONS=12
  
  !Dynamic options
  INTEGER(INTG), PARAMETER :: EQUATIONS_SET_STATIC_ANALYSIS=1
  INTEGER(INTG), PARAMETER :: EQUATIONS_SET_DYNAMIC_ANALYSIS=2

  !Damping options
  INTEGER(INTG), PARAMETER :: EQUATIONS_SET_NO_DAMPING=1
  INTEGER(INTG), PARAMETER :: EQUATIONS_SET_INDEPENDENT_DAMPING=2
  INTEGER(INTG), PARAMETER :: EQUATIONS_SET_RAYLEIGH_DAMPING=3
  
  !Constitutive law options
  INTEGER(INTG), PARAMETER :: EQUATIONS_SET_ST_VENANT_KIRCHOFF_CONSTITUTIVE_LAW=1
  INTEGER(INTG), PARAMETER :: EQUATIONS_SET_NEO_HOOKEAN_CONSTITUTIVE_LAW=2
  INTEGER(INTG), PARAMETER :: EQUATIONS_SET_MOONEY_RIVLIN_CONSTITUTIVE_LAW=3
  INTEGER(INTG), PARAMETER :: EQUATIONS_SET_HOLMES_MOW_CONSTITUTIVE_LAW=4
  INTEGER(INTG), PARAMETER :: EQUATIONS_SET_ISOTROPIC_EXP_CONSTITUTIVE_LAW=5
  INTEGER(INTG), PARAMETER :: EQUATIONS_SET_TRANS_ISOTROPIC_EXP_CONSTITUTIVE_LAW=6
  INTEGER(INTG), PARAMETER :: EQUATIONS_SET_TRANS_ISOTROPIC_POLYNOMIAL_CONSTITUTIVE_LAW=7
  INTEGER(INTG), PARAMETER :: EQUATIONS_SET_TRANS_ISOTROPIC_HUMPHREY_YIN_CONSTITUTIVE_LAW=8
  INTEGER(INTG), PARAMETER :: EQUATIONS_SET_TRANS_ISOTROPIC_GUCCIONE_CONSTITUTIVE_LAW=9
  INTEGER(INTG), PARAMETER :: EQUATIONS_SET_ORTHOTROPIC_COSTA_CONSTITUTIVE_LAW=10
  INTEGER(INTG), PARAMETER :: EQUATIONS_SET_ORTHOTROPIC_HOLZAPFEL_OGDEN_CONSTITUTIVE_LAW=11
  INTEGER(INTG), PARAMETER :: EQUATIONS_SET_ELASTICITY_DARCY_INRIA_CONSTITUTIVE_LAW=12
  INTEGER(INTG), PARAMETER :: EQUATIONS_SET_ELASTICITY_STATIC_INRIA_CONSTITUTIVE_LAW=13
  INTEGER(INTG), PARAMETER :: EQUATIONS_SET_ANISOTROPIC_POLYNOMIAL_CONSTITUTIVE_LAW=14
  INTEGER(INTG), PARAMETER :: EQUATIONS_SET_MEMBRANE_CONSTITUTIVE_LAW=15
  INTEGER(INTG), PARAMETER :: EQUATIONS_SET_CELLML_CONSTITUTIVE_LAW=16
 
  !Compressibility options
  INTEGER(INTG), PARAMETER :: EQUATIONS_SET_INCOMPRESSIBLE_MATERIAL=1
  INTEGER(INTG), PARAMETER :: EQUATIONS_SET_NEARLY_INCOMPRESSIBLE_MATERIAL=2
  INTEGER(INTG), PARAMETER :: EQUATIONS_SET_COMPRESSIBLE_MATERIAL=3
  
  !Configuration solution options
  INTEGER(INTG), PARAMETER :: EQUATIONS_SET_DEFORMED_SOLUTION_CONFIGURATION=1
  INTEGER(INTG), PARAMETER :: EQUATIONS_SET_REFERENCE_SOLUTION_CONFIGURATION=2
  
  !Active contractions options
  INTEGER(INTG), PARAMETER :: EQUATIONS_SET_NO_ACTIVE_CONTRACTION_METHOD=1
  INTEGER(INTG), PARAMETER :: EQUATIONS_SET_ACTIVE_CONTRACTION_STRESS_METHOD=2
  INTEGER(INTG), PARAMETER :: EQUATIONS_SET_ACTIVE_CONTRACTION_STRAIN_METHOD=3
  
  !Growth options
  INTEGER(INTG), PARAMETER :: EQUATIONS_SET_NO_GROWTH_METHOD=1
  INTEGER(INTG), PARAMETER :: EQUATIONS_SET_DECOMPOSITION_GROWTH_METHOD=2
  INTEGER(INTG), PARAMETER :: EQUATIONS_SET_RATE_BASED_GROWTH_METHOD=3
  
  !Growth law options
  INTEGER(INTG), PARAMETER :: EQUATIONS_SET_NO_GROWTH_LAW=1
  INTEGER(INTG), PARAMETER :: EQUATIONS_SET_FIBRE_GROWTH_LAW=2
  INTEGER(INTG), PARAMETER :: EQUATIONS_SET_ISOTROPIC_GROWTH_LAW=3
  INTEGER(INTG), PARAMETER :: EQUATIONS_SET_TRANSVERSELY_ISOTROPIC_GROWTH_LAW=4
  INTEGER(INTG), PARAMETER :: EQUATIONS_SET_ORTHOTROPIC_GROWTH_LAW=5
  INTEGER(INTG), PARAMETER :: EQUATIONS_SET_FULL_TENSOR_GROWTH_LAW=6
  INTEGER(INTG), PARAMETER :: EQUATIONS_SET_CELLML_GROWTH_LAW=7
  
  !Anisotropy options
  INTEGER(INTG), PARAMETER :: EQUATIONS_SET_ISOTROPIC_MATERIAL=1
  INTEGER(INTG), PARAMETER :: EQUATIONS_SET_TRANSVERSELY_ISOTROPIC_MATERIAL=2
  INTEGER(INTG), PARAMETER :: EQUATIONS_SET_ORTHOTROPIC_MATERIAL=3
  INTEGER(INTG), PARAMETER :: EQUATIONS_SET_ANISOTROPIC_MATERIAL=4
...
!  INTEGER(INTG), PARAMETER :: EQUATIONS_SET_INCOMPRESSIBLE_ELAST_MULTI_COMP_DARCY_SUBTYPE=14
  ...
  !> \see EquationsSetRoutines
  !>@{
  INTEGER(INTG), PARAMETER :: EQUATIONS_SET_DEFORMATION_GRADIENT_TENSOR=1 !<Deformation gradient tensor, F \see EquationsSetRoutines_TensorTypes,EquationsSetRoutines
  INTEGER(INTG), PARAMETER :: EQUATIONS_SET_DEFORMATION_GRADIENT_TENSOR_SPATIAL=2 !<Deformation gradient tensor pushed forward to spatial coordinates  \see EquationsSetConstants_TensorTypes,EquationsSetConstants
  INTEGER(INTG), PARAMETER :: EQUATIONS_SET_DEFORMATION_GRADIENT_TENSOR_FIBRE=3 !<Deformation gradient tensor wrt fibre coordinates FNu \see EquationsSetConstants_TensorTypes,EquationsSetConstants
  INTEGER(INTG), PARAMETER :: EQUATIONS_SET_DEFORMATION_ELASTIC_TENSOR=4 !<Deformation elastic tensor, Fe \see EquationsSetRoutines_TensorTypes,EquationsSetRoutines
  INTEGER(INTG), PARAMETER :: EQUATIONS_SET_DEFORMATION_GROWTH_TENSOR=5 !<Deformation growth tensor, Fg \see EquationsSetRoutines_TensorTypes,EquationsSetRoutines
  INTEGER(INTG), PARAMETER :: EQUATIONS_SET_RIGHT_STRETCH_TENSOR=6 !<Deformation right stretch tensor i.e., U, from F = R.U \see EquationsSetRoutines_TensorTypes,EquationsSetRoutines
  INTEGER(INTG), PARAMETER :: EQUATIONS_SET_LEFT_STRETCH_TENSOR=7 !<Deformation left stretch tensor i.e., v from F = v.R \see EquationsSetRoutines_TensorTypes,EquationsSetRoutines
  INTEGER(INTG), PARAMETER :: EQUATIONS_SET_ROTATION_TENSOR=8 !<Deformation rotation tensor i.e., R from F = R.U = v.R \see EquationsSetRoutines_TensorTypes,EquationsSetRoutines
  INTEGER(INTG), PARAMETER :: EQUATIONS_SET_RIGHT_STRETCH_TENSOR_FIBRE=9 !<Deformation right stretch tensor wrt fibre coordinates i.e., U, from FNu = R.U \see EquationsSetRoutines_TensorTypes,EquationsSetRoutines
  INTEGER(INTG), PARAMETER :: EQUATIONS_SET_LEFT_STRETCH_TENSOR_FIBRE=10 !<Deformation left stretch tensor wrt fibre coordinates i.e., v from FNu = v.R \see EquationsSetRoutines_TensorTypes,EquationsSetRoutines
  INTEGER(INTG), PARAMETER :: EQUATIONS_SET_ROTATION_TENSOR_FIBRE=11 !<Deformation rotation tensor wrt fibre coordinates i.e., R from FNu = R.U = v.R \see EquationsSetRoutines_TensorTypes,EquationsSetRoutines
  INTEGER(INTG), PARAMETER :: EQUATIONS_SET_R_CAUCHY_GREEN_DEFORMATION_TENSOR=12 !<Right Cauchy-Green deformation field, C \see EquationsSetRoutines_TensorTypes,EquationsSetRoutines
  INTEGER(INTG), PARAMETER :: EQUATIONS_SET_L_CAUCHY_GREEN_DEFORMATION_TENSOR=13 !<Right Cauchy-Green deformation field, b \see EquationsSetRoutines_TensorTypes,EquationsSetRoutines
  INTEGER(INTG), PARAMETER :: EQUATIONS_SET_GREEN_LAGRANGE_STRAIN_TENSOR=14 !<Green-Lagrange strain tensor, E \see EquationsSetRoutines_TensorTypes,EquationsSetRoutines
  INTEGER(INTG), PARAMETER :: EQUATIONS_SET_SMALL_STRAIN_TENSOR=15 !<Small strain tensor \see EquationsSetRoutines_TensorTypes,EquationsSetRoutines
  INTEGER(INTG), PARAMETER :: EQUATIONS_SET_CAUCHY_STRESS_TENSOR=16 !<Cauchy stress tensor, sigma \see EquationsSetRoutines_TensorTypes,EquationsSetRoutines
  INTEGER(INTG), PARAMETER :: EQUATIONS_SET_CAUCHY_STRESS_TENSOR_FIBRE=17 !<Cauchy stress tensor wrt deformed fibres, sigmaf \see EquationsSetConstants_TensorTypes,EquationsSetConstants
  INTEGER(INTG), PARAMETER :: EQUATIONS_SET_FIRST_PK_STRESS_TENSOR=18 !<First Piola Kirchhoff stress tensor, P \see EquationsSetRoutines_TensorEvaluateTypes,EquationsSetRoutines
  INTEGER(INTG), PARAMETER :: EQUATIONS_SET_SECOND_PK_STRESS_TENSOR=19 !<Second Piola Kirchhoff stress tensor, S \see EquationsSetRoutines_TensorEvaluateTypes,EquationsSetRoutines
  INTEGER(INTG), PARAMETER :: EQUATIONS_SET_ELASTIC_WORK=20 !<Elastic work \see EquationsSetRoutines_TensorEvaluateTypes,EquationsSetRoutines
  !>@}
  INTEGER(INTG), PARAMETER :: EQUATIONS_SET_NUMBER_OF_TENSOR_TYPES=20
  ...
  INTEGER(INTG), PARAMETER :: EQUATIONS_SET_LINEAR_ELASTICITY_CANTILEVER_END_LOAD=6
  !>@}
  ...
  INTEGER(INTG), PARAMETER :: EQUATIONS_SET_FINITE_ELASTICITY_CYLINDER_GROWTH=2
  !>@}
  ...
  PUBLIC EQUATIONS_SET_ONE_DIMENSIONAL_SUBTYPE,EQUATIONS_SET_TWO_DIMENSIONAL_PLANE_STRESS_SUBTYPE, &
    & EQUATIONS_SET_TWO_DIMENSIONAL_PLANE_STRAIN_SUBTYPE,EQUATIONS_SET_THREE_DIMENSIONAL_ISOTROPIC_SUBTYPE, &
    & EQUATIONS_SET_THREE_DIMENSIONAL_ORTHOTROPIC_SUBTYPE,EQUATIONS_SET_PLATE_SUBTYPE,EQUATIONS_SET_SHELL_SUBTYPE, &
    & EQUATIONS_SET_ONE_DIM_STOKES_DAMPING_SUBTYPE,EQUATIONS_SET_TWO_DIM_PLANE_STRESS_STOKES_DAMPING_SUBTYPE

  PUBLIC EQUATIONS_SET_ST_VENANT_KIRCHOFF_SUBTYPE,EQUATIONS_SET_NEO_HOOKEAN_SUBTYPE,EQUATIONS_SET_MOONEY_RIVLIN_SUBTYPE, &
    & EQUATIONS_SET_HOLMES_MOW_CONSTITUTIVE_LAW,EQUATIONS_SET_ISOTROPIC_EXP_SUBTYPE,EQUATIONS_SET_TRANS_ISOTROPIC_EXP_SUBTYPE, &
    & EQUATIONS_SET_TRANS_ISOTROPIC_POLYNOMIAL_SUBTYPE,EQUATIONS_SET_TRANS_ISOTROPIC_GUCCIONE_SUBTYPE, &
    & EQUATIONS_SET_TRANS_ISOTROPIC_HUMPHREY_YIN_SUBTYPE,EQUATIONS_SET_ORTHOTROPIC_COSTA_SUBTYPE, &
    & EQUATIONS_SET_ORTHOTROPIC_HOLZAPFEL_OGDEN_SUBTYPE, &
    & EQUATIONS_SET_ELASTICITY_DARCY_INRIA_MODEL_SUBTYPE,EQUATIONS_SET_ELASTICITY_MULTI_COMPARTMENT_DARCY_INRIA_SUBTYPE, &
    & EQUATIONS_SET_ANISOTROPIC_POLYNOMIAL_SUBTYPE

  PUBLIC EQUATIONS_SET_CONSTITUTIVE_LAW_IN_CELLML_EVALUATE_SUBTYPE

  PUBLIC EQUATIONS_SET_MEMBRANE_SUBTYPE

  PUBLIC EQUATIONS_SET_INCOMPRESSIBLE_FINITE_ELASTICITY_DARCY_SUBTYPE, &
    & EQUATIONS_SET_INCOMPRESSIBLE_ELASTICITY_DRIVEN_DARCY_SUBTYPE,EQUATIONS_SET_INCOMPRESSIBLE_ELASTICITY_DRIVEN_MR_SUBTYPE, &
    & EQUATIONS_SET_INCOMPRESSIBLE_ELAST_MULTI_COMP_DARCY_SUBTYPE

  PUBLIC EQUATIONS_SET_ELASTICITY_FLUID_PRESSURE_STATIC_INRIA_SUBTYPE,EQUATIONS_SET_ELASTICITY_FLUID_PRESSURE_HOLMES_MOW_SUBTYPE, &
    & EQUATIONS_SET_ELASTICITY_FLUID_PRES_HOLMES_MOW_ACTIVE_SUBTYPE

  PUBLIC EQUATIONS_SET_COMPRESSIBLE_FINITE_ELASTICITY_SUBTYPE,EQUATIONS_SET_COMPRESSIBLE_ST_VENANT_KIRCHOFF_SUBTYPE, &
    & EQUATIONS_SET_COMPRESSIBLE_NEO_HOOKEAN_SUBTYPE,EQUATIONS_SET_COMPRESSIBLE_MOONEY_RIVLIN_SUBTYPE

  PUBLIC EQUATIONS_SET_NEARLY_INCOMP_ST_VENANT_KIRCHOFF_SUBTYPE,EQUATIONS_SET_NEARLY_INCOMP_NEO_HOOKEAN_SUBTYPE, &
    & EQUATIONS_SET_NEARLY_INCOMP_MOONEY_RIVLIN_SUBTYPE

  PUBLIC EQUATIONS_SET_ACTIVE_CONTRACTION_SUBTYPE,EQUATIONS_SET_ST_VENANT_KIRCHOFF_ACTIVE_CONTRACTION_SUBTYPE, &
    & EQUATIONS_SET_NEO_HOOKEAN_ACTIVE_CONTRACTION_SUBTYPE,EQUATIONS_SET_MOONEY_RIVLIN_ACTIVE_CONTRACTION_SUBTYPE, &
    & EQUATIONS_SET_TRANS_ISOTROPIC_ACTIVE_CONTRACTION_SUBTYPE, &
    & EQUATIONS_SET_ANISOTROPIC_POLYNOMIAL_ACTIVE_CONTRACTION_SUBTYPE, &
    & EQUATIONS_SET_TRANS_ISOTROPIC_ACTIVE_TRANSITION_SUBTYPE,EQUATIONS_SET_GUCCIONE_ACTIVE_CONTRACTION_SUBTYPE, &
    & EQUATIONS_SET_GUCCIONE_ACTIVE_CONTRACTION_NOLENDEP_SUBTYPE,EQUATIONS_SET_GUCCIONE_ACTIVE_CONTRACTION_2NDPIOLA_SUBTYPE, &
    & EQUATIONS_SET_HOLZAPFEL_OGDEN_ACTIVE_CONTRACTION_SUBTYPE,EQUATIONS_SET_COMPRESSIBLE_ACTIVE_CONTRACTION_SUBTYPE

  PUBLIC EQUATIONS_SET_CONSTITUTIVE_AND_GROWTH_LAW_IN_CELLML_SUBTYPE,EQUATIONS_SET_CELLML_GROWTH_LAW_SUBTYPE, &
    & EQUATIONS_SET_CELLML_GROWTH_LAW_ST_VENANT_SUBTYPE,EQUATIONS_SET_CELLML_GROWTH_LAW_NEO_HOOKEAN_SUBTYPE, &
    & EQUATIONS_SET_CELLML_GROWTH_LAW_MOONEY_RIVLIN_SUBTYPE

  PUBLIC EQUATIONS_SET_FIBRE_GROWTH_LAW_ST_VENANT_SUBTYPE,EQUATIONS_SET_ISOTROPIC_GROWTH_LAW_ST_VENANT_SUBTYPE, &
    & EQUATIONS_SET_TRANS_ISO_GROWTH_LAW_ST_VENANT_SUBTYPE,EQUATIONS_SET_ORTHOTROPIC_GROWTH_LAW_ST_VENANT_SUBTYPE, &
    & EQUATIONS_SET_FULL_TENSOR_GROWTH_LAW_ST_VENANT_SUBTYPE

  PUBLIC EQUATIONS_SET_FIBRE_GROWTH_LAW_NEO_HOOKEAN_SUBTYPE,EQUATIONS_SET_ISOTROPIC_GROWTH_LAW_NEO_HOOKEAN_SUBTYPE, &
    & EQUATIONS_SET_TRANS_ISO_GROWTH_LAW_NEO_HOOKEAN_SUBTYPE,EQUATIONS_SET_ORTHOTROPIC_GROWTH_LAW_NEO_HOOKEAN_SUBTYPE, &
    & EQUATIONS_SET_FULL_TENSOR_GROWTH_LAW_NEO_HOOKEAN_SUBTYPE

  PUBLIC EQUATIONS_SET_FIBRE_GROWTH_LAW_MOONEY_RIVLIN_SUBTYPE,EQUATIONS_SET_ISOTROPIC_GROWTH_LAW_MOONEY_RIVLIN_SUBTYPE, &
    & EQUATIONS_SET_TRANS_ISO_GROWTH_LAW_MOONEY_RIVLIN_SUBTYPE,EQUATIONS_SET_ORTHOTROPIC_GROWTH_LAW_MOONEY_RIVLIN_SUBTYPE, &
    & EQUATIONS_SET_FULL_TENSOR_GROWTH_LAW_MOONEY_RIVLIN_SUBTYPE

  PUBLIC EQUATIONS_SET_ACTIVE_STRAIN_SUBTYPE,EQUATIONS_SET_MULTISCALE_ACTIVE_STRAIN_SUBTYPE

  PUBLIC EQUATIONS_SET_RATE_BASED_SMOOTH_MODEL_SUBTYPE,EQUATIONS_SET_RATE_BASED_GROWTH_MODEL_SUBTYPE, &
    & EQUATIONS_SET_COMPRESSIBLE_RATE_BASED_SMOOTH_MODEL_SUBTYPE,EQUATIONS_SET_COMPRESSIBLE_RATE_BASED_GROWTH_MODEL_SUBTYPE

  PUBLIC EQUATIONS_SET_REFERENCE_STATE_ST_VENANT_KIRCHOFF_SUBTYPE,EQUATIONS_SET_REFERENCE_STATE_NEO_HOOKEAN_SUBTYPE, &
    & EQUATIONS_SET_REFERENCE_STATE_MOONEY_RIVLIN_SUBTYPE,EQUATIONS_SET_REFERENCE_STATE_TRANS_GUCCIONE_SUBTYPE

  PUBLIC EQUATIONS_SET_DYNAMIC_ST_VENANT_KIRCHOFF_SUBTYPE,EQUATIONS_SET_DYNAMIC_NEO_HOOKEAN_SUBTYPE, &
    & EQUATIONS_SET_DYNAMIC_MOONEY_RIVLIN_SUBTYPE

  PUBLIC EQUATIONS_SET_DYNAMIC_COMPRESSIBLE_ST_VENANT_KIRCHOFF_SUBTYPE,EQUATIONS_SET_DYNAMIC_COMPRESSIBLE_NEO_HOOKEAN_SUBTYPE, &
    & EQUATIONS_SET_DYNAMIC_COMPRESSIBLE_MOONEY_RIVLIN_SUBTYPE

  PUBLIC EQUATIONS_SET_DYNAMIC_NEARLY_INCOMP_ST_VENANT_KIRCHOFF_SUBTYPE, &
    & EQUATIONS_SET_DYNAMIC_NEARLY_INCOMP_NEO_HOOKEAN_SUBTYPE, &
    & EQUATIONS_SET_DYNAMIC_NEARLY_INCOMP_MOONEY_RIVLIN_SUBTYPE

  PUBLIC EQUATIONS_SET_EQUATION_CLASS_OPTION,EQUATIONS_SET_EQUATION_TYPE_OPTION,EQUATIONS_SET_EQUATION_SUBTYPE_OPTION, &
    & EQUATIONS_SET_TEMPORAL_ANALYSIS_OPTION,EQUATIONS_SET_DAMPING_OPTION,EQUATIONS_SET_CONSTITUTIVE_LAW_OPTION, &
    & EQUATIONS_SET_MATERIAL_COMPRESSIBILITY_OPTION,EQUATIONS_SET_SOLUTION_CONFIGURATION_OPTION, &
    & EQUATIONS_SET_ACTIVE_CONTRACTION_OPTION,EQUATIONS_SET_MATERIAL_GROWTH_OPTION,EQUATIONS_SET_MATERIAL_GROWTH_LAW_OPTION, &
    & EQUATIONS_SET_MATERIAL_ANISOTROPY_OPTION,EQUATIONS_SET_MAX_OPTIONS

  PUBLIC EQUATIONS_SET_STATIC_ANALYSIS,EQUATIONS_SET_DYNAMIC_ANALYSIS

  PUBLIC EQUATIONS_SET_NO_DAMPING,EQUATIONS_SET_INDEPENDENT_DAMPING,EQUATIONS_SET_RAYLEIGH_DAMPING

  PUBLIC EQUATIONS_SET_ST_VENANT_KIRCHOFF_CONSTITUTIVE_LAW,EQUATIONS_SET_NEO_HOOKEAN_CONSTITUTIVE_LAW, &
    & EQUATIONS_SET_MOONEY_RIVLIN_CONSTITUTIVE_LAW,EQUATIONS_SET_ISOTROPIC_EXP_CONSTITUTIVE_LAW, &
    & EQUATIONS_SET_TRANS_ISOTROPIC_EXP_CONSTITUTIVE_LAW, &
    & EQUATIONS_SET_TRANS_ISOTROPIC_POLYNOMIAL_CONSTITUTIVE_LAW, &
    & EQUATIONS_SET_TRANS_ISOTROPIC_HUMPHREY_YIN_CONSTITUTIVE_LAW, &
    & EQUATIONS_SET_TRANS_ISOTROPIC_GUCCIONE_CONSTITUTIVE_LAW, &
    & EQUATIONS_SET_ORTHOTROPIC_COSTA_CONSTITUTIVE_LAW,EQUATIONS_SET_ORTHOTROPIC_HOLZAPFEL_OGDEN_CONSTITUTIVE_LAW, &
    & EQUATIONS_SET_ELASTICITY_DARCY_INRIA_CONSTITUTIVE_LAW,EQUATIONS_SET_ELASTICITY_STATIC_INRIA_CONSTITUTIVE_LAW, &
    & EQUATIONS_SET_ANISOTROPIC_POLYNOMIAL_CONSTITUTIVE_LAW,EQUATIONS_SET_MEMBRANE_CONSTITUTIVE_LAW, &
    & EQUATIONS_SET_CELLML_CONSTITUTIVE_LAW

  PUBLIC EQUATIONS_SET_INCOMPRESSIBLE_MATERIAL,EQUATIONS_SET_NEARLY_INCOMPRESSIBLE_MATERIAL,EQUATIONS_SET_COMPRESSIBLE_MATERIAL

  PUBLIC EQUATIONS_SET_DEFORMED_SOLUTION_CONFIGURATION,EQUATIONS_SET_REFERENCE_SOLUTION_CONFIGURATION

  PUBLIC EQUATIONS_SET_NO_ACTIVE_CONTRACTION_METHOD,EQUATIONS_SET_ACTIVE_CONTRACTION_STRESS_METHOD, &
    & EQUATIONS_SET_ACTIVE_CONTRACTION_STRAIN_METHOD

  PUBLIC EQUATIONS_SET_NO_GROWTH_METHOD,EQUATIONS_SET_DECOMPOSITION_GROWTH_METHOD,EQUATIONS_SET_RATE_BASED_GROWTH_METHOD

  PUBLIC EQUATIONS_SET_NO_GROWTH_LAW,EQUATIONS_SET_FIBRE_GROWTH_LAW,EQUATIONS_SET_ISOTROPIC_GROWTH_LAW, &
    & EQUATIONS_SET_TRANSVERSELY_ISOTROPIC_GROWTH_LAW,EQUATIONS_SET_ORTHOTROPIC_GROWTH_LAW, &
    & EQUATIONS_SET_FULL_TENSOR_GROWTH_LAW,EQUATIONS_SET_CELLML_GROWTH_LAW

  PUBLIC EQUATIONS_SET_ISOTROPIC_MATERIAL,EQUATIONS_SET_TRANSVERSELY_ISOTROPIC_MATERIAL,EQUATIONS_SET_ORTHOTROPIC_MATERIAL, &
    & EQUATIONS_SET_ANISOTROPIC_MATERIAL
  ...
  PUBLIC EQUATIONS_SET_DEFORMATION_GRADIENT_TENSOR,EQUATIONS_SET_DEFORMATION_GRADIENT_TENSOR_SPATIAL, &
    & EQUATIONS_SET_DEFORMATION_GRADIENT_TENSOR_FIBRE,EQUATIONS_SET_DEFORMATION_ELASTIC_TENSOR, &
    & EQUATIONS_SET_DEFORMATION_GROWTH_TENSOR, &
    & EQUATIONS_SET_RIGHT_STRETCH_TENSOR,EQUATIONS_SET_LEFT_STRETCH_TENSOR,EQUATIONS_SET_ROTATION_TENSOR, &
    & EQUATIONS_SET_RIGHT_STRETCH_TENSOR_FIBRE,EQUATIONS_SET_LEFT_STRETCH_TENSOR_FIBRE,EQUATIONS_SET_ROTATION_TENSOR_FIBRE, &
    & EQUATIONS_SET_R_CAUCHY_GREEN_DEFORMATION_TENSOR,EQUATIONS_SET_SMALL_STRAIN_TENSOR, &
    & EQUATIONS_SET_L_CAUCHY_GREEN_DEFORMATION_TENSOR,EQUATIONS_SET_GREEN_LAGRANGE_STRAIN_TENSOR, &
    & EQUATIONS_SET_CAUCHY_STRESS_TENSOR,EQUATIONS_SET_CAUCHY_STRESS_TENSOR_FIBRE, &
    & EQUATIONS_SET_FIRST_PK_STRESS_TENSOR,EQUATIONS_SET_SECOND_PK_STRESS_TENSOR, &
    & EQUATIONS_SET_ELASTIC_WORK,EQUATIONS_SET_NUMBER_OF_TENSOR_TYPES
  ...
  PUBLIC EQUATIONS_SET_LINEAR_ELASTICITY_ONE_DIM_1,EQUATIONS_SET_LINEAR_ELASTICITY_TWO_DIM_1, &
    ...
    & EQUATIONS_SET_LINEAR_ELASTICITY_THREE_DIM_2,EQUATIONS_SET_LINEAR_ELASTICITY_CANTILEVER_END_LOAD

  PUBLIC EQUATIONS_SET_FINITE_ELASTICITY_CYLINDER,EQUATIONS_SET_FINITE_ELASTICITY_CYLINDER_GROWTH
  ...
  PUBLIC EquationsSet_SpecificationOptionGet
...
999 ERRORSEXITS("EquationsSet_SpecificationSet1",err,error)
  ...
  !>Returns an option of a equations set specification 
  SUBROUTINE EquationsSet_SpecificationOptionGet(equationsSet,specificationOptionIndex,equationsSetSpecification,err,error,*)

    !Argument variables
    TYPE(EquationsSetType), POINTER :: equationsSet !<A pointer to the equations set to get the specification for
    INTEGER(INTG), INTENT(IN) :: specificationOptionIndex !<The specification option index to get
    INTEGER(INTG), INTENT(OUT) :: equationsSetSpecification !<On return, The equation set specification option.
    INTEGER(INTG), INTENT(OUT) :: err !<The error code
    TYPE(VARYING_STRING), INTENT(OUT) :: error !<The error string
    !Local Variables
#ifdef WITH_PRECHECKS    
    ...
    ENTERS("EquationsSet_SpecificationOptionGet",err,error,*999)
   
#ifdef WITH_PRECHECKS    
    IF(.NOT.ASSOCIATED(equationsSet)) CALL FlagError("Equations set is not associated.",err,error,*999)
    IF(.NOT.ALLOCATED(equationsSet%specification)) THEN
      localError="The specification is not allocated for equations set number "// &
        & TRIM(NumberToVString(equationsSet%userNumber,"*",err,error))
      IF(ASSOCIATED(equationsSet%region)) &
        & localError=localError//" of region number "//TRIM(NumberToVString(equationsSet%region%userNumber,"*",err,error))
      localError=localError//"."
      CALL FlagError(localError,err,error,*999)
    ENDIF
    IF(specificationOptionIndex<1.OR.specificationOptionIndex>equationsSet%specificationLength) THEN
      localError="The specification option index of "//TRIM(NumberToVString(specificationOptionIndex,"*",err,error))// &
        & " is invalid. The index must be >= 1 and <= "// &
        & TRIM(NumberToVString(equationsSet%specificationLength,"*",err,error))//"."
      CALL FlagError(localError,err,error,*999)
    ENDIF
#endif
       
    equationsSetSpecification=equationsSet%specification(specificationOptionIndex)

    EXITS("EquationsSet_SpecificationOptionGet")
    RETURN
999 ERRORSEXITS("EquationsSet_SpecificationOptionGet",err,error)
    RETURN 1
    
  END SUBROUTINE EquationsSet_SpecificationOptionGet
