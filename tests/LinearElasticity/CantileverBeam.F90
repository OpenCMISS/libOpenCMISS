...
#include "mpif.h"
  ...
  REAL(OCRP), PARAMETER :: ORIGIN(3)=[0.0_OCRP,-1.0_OCRP,-1.0_OCRP]
  REAL(OCRP), PARAMETER :: LENGTH=5.0_OCRP
...
CONTAINS
  ...
  SUBROUTINE ANALYTIC_LINEAR_ELASTICITY_GENERIC(NumberGlobalXElements,NumberGlobalYElements,NumberGlobalZElements, &
    ...
    TYPE(OC_FieldType) :: AnalyticField,GeometricField,EquationsSetField,MaterialField
...
!    ELSE
      ...
      AnalyticFunction=OC_EQUATIONS_SET_LINEAR_ELASTICITY_THREE_DIM_2
      !Prescribe material properties E1,E2,E3 & v13,v23,v12
      FieldMaterialNumberOfComponents = 6 !Young's Modulus & Poisson's Ratio
      MaterialParameters = [10.0E3_OCRP,10.0E3_OCRP,10.0E3_OCRP,0.45_OCRP,0.45_OCRP,0.45_OCRP]
!    ENDIF
...
CALL OC_EquationsSet_CreateStart(EquationSetUserNumber,Region,GeometricField,[OC_EQUATIONS_SET_ELASTICITY_CLASS, &
  & OC_EQUATIONS_SET_LINEAR_ELASTICITY_TYPE,EquationSetSubtype],EquationsSetFieldUserNumber,EquationsSetField,EquationsSet,Err)
